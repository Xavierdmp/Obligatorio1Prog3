...
namespace Obligatorio1.Persistencia
{
    public class pAccesorio : IABM<Accesorio>, IBuscar<Accesorio>
    {
        ...
        const string UltimaId = "Declare @UltimaId int; Set @UltimaId = @@Identity;"; // No se va a modificar nunca//
