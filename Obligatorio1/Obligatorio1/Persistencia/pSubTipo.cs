...
{
    public class pSubTipo : ABM<SubTipo>, Buscar<SubTipo>
    {
        ...
        {
            string instruccion = "Select * from where nombre_Subtipo=" + "'" + pNombre + "'";
        ...
        public SubTipo Buscar(int pId)
        {
            ...
            if (data != null)
            {
                ...
                foreach (DataRow row in table)
                {
                    ...
                    int idSubtipo = int.Parse(element[2].ToString());
                    unSubtipo.TipoInstrumento = Controladora.Instancia.BuscarTipo(idSubtipo);
                }
                return unSubtipo;
            }
            return null;
        ...
        {
            return Conexion.Instancia.InicializarConsulta("update from SubTipos set nombre_Subtipo=" + "'" + pSubtipo.Nombre + "'," + "id_Tipo=" + pSubtipo.TipoInstrumento.Id + " where id_Subtipo=" + pSubtipo.Id + ";");
        }
