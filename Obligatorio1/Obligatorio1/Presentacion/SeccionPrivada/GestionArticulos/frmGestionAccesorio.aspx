        ...
        <section class="row" style="margin-top: 50px;">
            <article class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtDescripcion" runat="server" placeholder="Ingrese una descripcion" class="form-control" TextMode="MultiLine" Width="281px"></asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="dplListaFabricante" runat="server" class="form-control" Width="280px" AutoPostBack="True" AppendDataBoundItems="True">
                ...
                <div class="form-group">
                    ...
                    <asp:FileUpload ID="fuImagenPrincipal" runat="server" class="form-control" />
                </div>
            </article>
            <article class="col-md-3">
                <div class="form-group">
