        ...
        <section class="row" style="margin-top: 50px;">
            ...
            <aside class="col-md-6 text-center">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="dplListarSubtipo" runat="server" class="form-control cargarFotosAdicionales" Width="280px" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged="dplListarSubtipo_SelectedIndexChanged">
                        <asp:ListItem>Seleccione un subtipo de instrumento</asp:ListItem>
                    </asp:DropDownList>
                </div>
                <div class="form-group">
                    <asp:GridView ID="gvListarSubtiposDeAccesorio" runat="server" HorizontalAlign="Center"></asp:GridView>
                </div>
            </aside>
        </section>
