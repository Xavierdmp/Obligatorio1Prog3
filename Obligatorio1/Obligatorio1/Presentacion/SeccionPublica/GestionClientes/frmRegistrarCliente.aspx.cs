...
namespace Obligatorio1.Presentacion.Seccion_Publica.Gestion_Clientes
{
    public partial class frmRegistrarCliente : System.Web.UI.Page
    {
        ...
        protected void btnAlta_Click(object sender, EventArgs e)
        {
            ...
            Dominio.Cliente unCliente = new Dominio.Cliente(genero, correo, contraseña, nombre, apellido, cedulaidentidad, direccion, telefono);
